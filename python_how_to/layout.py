...
class Example(Frame):
    ...
    def initUI(self):
        ...
        area1 = TkinterGraph(self)
        area1.grid(row=1, column=0, columnspan=2, rowspan=4, 
        ...
        btn1 = Button(self, text="Test1")
        btn1.grid(row=1, column=6)

        btn2 = Button(self, text="Test2")
        btn2.grid(row=2, column=6, pady=4)
        
        btn3 = Button(self, text="Test3")
